export const simuladosTokens = {
  ...
  createButton: 'flex h-10 shrink-0 items-center gap-[7px] whitespace-nowrap rounded-[13px] border-0 bg-[#66558f] px-[18px] text-[11px] font-extrabold text-white cursor-pointer transition-colors hover:bg-[#543c78]',

  /* Stats strip */
  stats: 'flex flex-wrap items-center rounded-[18px] border border-[#e5dfe8] bg-white px-[22px] py-[14px]',
  stat: 'flex min-w-[80px] flex-1 flex-col gap-px px-4 first:pl-0 max-sm:px-2',
  statValue: 'text-[22px] font-black text-[#1e1829] leading-none',
  statLabel: 'text-[9px] font-extrabold tracking-[0.08em] uppercase text-[#9080a8]',
  ...
  resultRow: 'grid grid-cols-[auto_1fr_auto] items-start gap-x-4 gap-y-3 rounded-[18px] border border-[#e5dfe8] bg-white px-[18px] py-[14px] transition-shadow hover:shadow-[0_4px_16px_rgba(61,43,90,0.08)] max-sm:grid-cols-[auto_1fr]',
  resultActions: 'flex shrink-0 items-center gap-1.5 max-sm:col-span-full max-sm:justify-end',
  scoreRing: 'relative w-14 h-14 shrink-0 grid place-items-center mt-0.5',
  scoreRingSvg: 'absolute inset-0 w-full h-full',
  scoreRingLabel: 'relative z-[1] text-xs font-black tracking-[-0.04em]',
  resultBody: 'flex-1 min-w-0 flex flex-col gap-1',
  resultName: 'text-[13px] font-extrabold text-[#1e1829]',
  resultTags: 'flex flex-wrap items-center gap-1.5 text-[10px] text-[#9080a8] font-semibold',
  resultSep: 'text-[#cfc2d8] text-[10px]',
  resultDate: 'text-[10px] text-[#b0a0bc]',

  /* Action buttons */
  actionBtn: 'inline-flex items-center gap-[5px] h-[30px] px-2.5 rounded-[9px] text-[11px] font-bold cursor-pointer border-[1.5px] border-transparent transition-colors whitespace-nowrap',
  actionGhost: 'border-[#ddd0ee] bg-white text-[#66558f] hover:bg-[#f4eefa] hover:border-[#b8a0d0]',
  actionIcon: 'border-[#e5dfe8] bg-white text-[#66558f] px-2 hover:bg-[#f4eefa] hover:border-[#b8a0d0]',
  actionDanger: 'border-[#e5dfe8] bg-white text-[#c0395a] px-2 hover:bg-[#fce8ef] hover:border-[#e0b0bc]',
  ...
  materiaRow: 'grid grid-cols-[160px_1fr_38px_80px] items-center gap-2.5 max-sm:grid-cols-[1fr_1fr_36px_48px]',
  materiaName: 'text-[11px] font-bold text-[#3d2b5a] whitespace-nowrap overflow-hidden text-ellipsis',
  materiaBarWrap: 'h-1.5 bg-[#f0eaf6] rounded-full overflow-hidden',
  materiaBar: 'h-full rounded-full transition-[width_0.3s]',
  materiaPct: 'text-[11px] font-extrabold text-right',
  materiaDetail: 'text-[10px] text-[#9080a8] text-right',
  ...
  /* Redo btn */
  redoBtn: 'h-[34px] px-[14px] border-[1.5px] border-[#ddd0ee] rounded-[10px] bg-white text-[#66558f] text-[11px] font-extrabold cursor-pointer whitespace-nowrap shrink-0 transition-colors hover:bg-[#f4eefa] hover:border-[#b8a0d0]',

  /* Empty state */
  empty: 'flex flex-col items-center justify-center gap-3 py-16 px-6 text-center bg-white border border-[#e5dfe8] rounded-[20px]',
  ...
  emptyButton: 'h-10 px-5 border-0 rounded-xl bg-[#66558f] text-white text-xs font-extrabold cursor-pointer mt-1 transition-colors hover:bg-[#543c78]',
  ...
  dialogHeader: 'flex items-start justify-between gap-4 px-6 pt-5 pb-4 border-b border-[#ede7f2] shrink-0',
  dialogEyebrow: 'text-[9px] font-extrabold tracking-[0.1em] uppercase text-[#9472c8]',
  dialogTitle: 'text-[19px] font-extrabold text-[#1e1829] mt-1',
  ...
  dialogFooter: 'flex items-center justify-end gap-2.5 px-6 py-[14px] border-t border-[#ede7f2] shrink-0 bg-white',
  btnGhost: 'h-10 px-[18px] border-[1.5px] border-[#ddd0ee] rounded-xl bg-white text-[#66558f] text-xs font-extrabold cursor-pointer transition-colors hover:bg-[#f4eefa]',
  btnPrimary: 'flex items-center gap-[7px] h-10 px-5 border-0 rounded-xl bg-[#66558f] text-white text-xs font-extrabold cursor-pointer transition-colors hover:bg-[#543c78]',

  /* Create form */
  createForm: 'flex flex-col gap-4 px-6 py-5 overflow-y-auto flex-1 min-h-0',
  ...
  mfTitle: 'text-xs font-bold text-[#3d2b5a] flex-1 min-w-0',
