...
export default function CalendarView() {
  ...
  return <div className="journey-hub">
    ...
    <div className={t.page}>
      <header className={t.header}><div><span className={t.eyebrow}>ORGANIZAÇÃO</span><h1 className={t.title}>Calendário</h1><p className={t.subtitle}>Anote provas, boletos, editais e lembretes importantes.</p></div><button className={t.primaryButton} onClick={() => openNew()}>＋ Novo evento</button></header>
