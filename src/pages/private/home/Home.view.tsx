...
export function HomeView(props: HomeViewProps) {
  ...
  return <div className="journey-hub">
    <header className="hub-topbar">
      ...
      <nav className="hub-nav" aria-label="Navegação principal"><button className="active" type="button">Jornadas</button><button type="button" disabled>Agenda</button><button type="button" disabled>Desempenho</button></nav>
