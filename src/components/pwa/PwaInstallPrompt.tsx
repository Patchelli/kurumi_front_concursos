...
export function PwaInstallPrompt() {
  ...
  if (!prompt || hidden || isPublicPage) return null;
  ...
  return <aside className="pwa-install-card" aria-label="Instalar Kurumi">
    ...
    <div className="pwa-install-copy"><small>INSTALAR APLICATIVO</small><strong>Leve o Kurumi para sua tela inicial</strong><span>Acesse seus estudos como um app.</span></div>
